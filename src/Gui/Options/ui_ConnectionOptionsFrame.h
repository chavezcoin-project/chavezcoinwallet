...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Chavezcoin daemon process on port 8081. In case of no local daemon running it will use an in-wallet embedded node implementation.", 0));
        m_embeddedRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Embedded", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "An in-wallet embedded Chavezcoin node will be used.", 0));
        ...
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Chavezcoin daemon process. Please specify daemon's port.", 0));
        ...
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to Chavezcoin node running on another PC in the local or global network. Please specify IP address or domain name and the port.", 0));
    } // retranslateUi

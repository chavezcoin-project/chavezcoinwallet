...
const char COMMUNITY_FORUM_URL[] = "https://chavezcointalk.org";
const char REPORT_ISSUE_URL[] = "https://chavezcoin.org/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Chavezcoin Wallet %1").arg(Settings::instance().getVersion()));
